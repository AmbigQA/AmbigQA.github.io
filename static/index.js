(function() {
  ...
  let references = {
    ...
    "ours": "https://arxiv.org/abs/2004.10645",
    ...
    $( window ).init(function(){
      ...
      $('#intro-content').append(`
        ...
        <p>
          ...
          For instance, nearly half of questions from NQ-open (an existing open-domain QA benchmark)
          are ambiguous.
          The types of ambiguity are diverse and sometimes subtle, many of which are only apparent
          after examining evidence provided by a very large text corpus.
          Here, we introduce a series of tasks to answer ambiguous open-domain questions.
        </p>
        ...
        <p>
          <span style="color: #5540a3; font-size: 110%"><strong>AmbigQA</strong></span> requires to predict a set of question-answer pairs,
          where every plausible answer is paired with a disambiguated rewrite of the original question.
        </p>
        <p>
          <span style="color: #5540a3; font-size: 110%"><strong>ASQA</strong></span> requires to provide a long-form summary that resolves the ambiguity.
          Providing a long-form answer to ambiguous questions requires to synthesize
        ...
        <blockquote>
          ...
          <a href="` + asqa_references["paper"] + `" target="_blank">"ASQA: Factoid Questions Meet Long-Form Answers"</a>.
          2022.
          [<a href="` + asqa_references["bibtex"] + `" target="_blank">BibTeX</a>]
        </blockquote>
      `);
      ...
      $('.panel').width($('#intro-content').width()/4-30);
